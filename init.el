...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet web-mode use-package smex smartparens projectile prodigy popwin pallet nyan-mode multiple-cursors magit lsp-ui lsp-ruby idle-highlight-mode htmlize flycheck-cask expand-region exec-path-from-shell drag-stuff company-lsp))))
(custom-set-faces
